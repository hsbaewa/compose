...
//    signAllPublications() // Gpg 서명을 위한 설정
    ...
    coordinates("io.github.hsbaewa", "compose", "0.0.10") // 네임 스페이스, 라이브러리 이름, 버전 순서로 작성
    ...
    pom {
         ...
         */
        name = "compose"
        description = "Compose Library"
        url = "https://github.com/hsbaewa/compose"
        inceptionYear = "2025"
        ...
        licenses {
            license {
                name = "Apache License"
                url = "https://github.com/hsbaewa/compose/blob/main/LICENSE"
            }
        }
